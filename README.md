...
|----------------|---------------------------------|-----------------------------|
|**/src**	 |`"001led_toggle.c"` <br> `"002led_button.c"` <br> `"003HSI_Measurement.c"` <br> `"004Button_interrupt.c"` <br> `"005Spi_Tx.c"` <br> `"006spi_tx_only_avr.c"` <br> `"007spi_cmd_handling.c"` <br> `"008Spi_IRQ_avr.c"` <br> `"009I2C_master_tx_testing.c"` <br> `"010i2c_master_rx_testing.c"`		   	   |**<ul><li>Led Toggle Application</li> <br> <li>Led/Button Application</li> <br> <li>Measuring Internal Clock Application</li> <br> <li>Interrupt Button Application</li> <br> <li>SPI transmission test Application</li> <br> <li>SPI Transmission Only Application</li> <br> <li>SPI Command Application</li> <br> <li>SPI and AVR Application</li> <br> <li>I2C master testing Application</li> <br> <li>I2C master reception Application</li></ul>** |
